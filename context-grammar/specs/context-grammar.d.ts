 ...
 *
 * Source of truth for the 8 Context Tokens, 23 AX Patterns, and rule engine API.
...
/**
 * Complete Context Grammar token state.
 * All 8 tokens must be set before the rule engine can evaluate.
 */
